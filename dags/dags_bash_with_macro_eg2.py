...
with DAG(
    ...
    bash_t2 = BashOperator(
        ...
        env= {'START_DATE': '{{ (data_interval_start.in_timezone("Asia/Seoul")  + macros.dateutil.relativedelta.relativedelta(days=-19)) | ds}}',  # 2주전 월요일
              'END_DATE':'{{(data_interval_end.in_timezone("Asia/Seoul")  + macros.dateutil.relativedelta.relativedelta(days=-14)) | ds }}'}, # 2주전 토요일
